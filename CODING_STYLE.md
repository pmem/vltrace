...
vltrace code. To ensure readability and consistency within the code,
the contributed code must adhere to the rules below.

### Introduction
The vltrace coding style is quite similar to the style used for the SunOS product.
...
used in writing vltrace code, but rather focuses on some vltrace-specific conventions,
...
[style checker program](https://github.com/pmem/vltrace/blob/master/utils/cstyle)
...
See [CONTRIBUTING.md](https://github.com/pmem/vltrace/blob/master/CONTRIBUTING.md) for details.
- A copy of the [BSD-style License](https://github.com/pmem/vltrace/blob/master/LICENSE)
